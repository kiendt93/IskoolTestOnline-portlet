...
import com.vietnamobile.service.OnlinetestResultEntryLocalService;
...
/**
 * Provides the base implementation for the onlinetest result entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vietnamobile.service.impl.OnlinetestResultEntryLocalServiceImpl}.
 * </p>
 *
 * @author duymb
 ...
 * @generated
 */
public abstract class OnlinetestResultEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements OnlinetestResultEntryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vietnamobile.service.OnlinetestResultEntryLocalServiceUtil} to access the onlinetest result entry local service.
	 */
	...
	@Override
	public OnlinetestResultEntry addOnlinetestResultEntry(
		OnlinetestResultEntry onlinetestResultEntry) throws SystemException {
		onlinetestResultEntry.setNew(true);

		return onlinetestResultEntryPersistence.update(onlinetestResultEntry);
	}
	 ...
	 */
	@Override
	public OnlinetestResultEntry createOnlinetestResultEntry(
		long onlinetestResultEntryId) {
		return onlinetestResultEntryPersistence.create(onlinetestResultEntryId);
	}
	...
	@Override
	public OnlinetestResultEntry deleteOnlinetestResultEntry(
		long onlinetestResultEntryId) throws PortalException, SystemException {
		return onlinetestResultEntryPersistence.remove(onlinetestResultEntryId);
	}
	...
	public OnlinetestResultEntry deleteOnlinetestResultEntry(
		OnlinetestResultEntry onlinetestResultEntry) throws SystemException {
		return onlinetestResultEntryPersistence.remove(onlinetestResultEntry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(OnlinetestResultEntry.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return onlinetestResultEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return onlinetestResultEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public OnlinetestResultEntry fetchOnlinetestResultEntry(
		long onlinetestResultEntryId) throws SystemException {
		return onlinetestResultEntryPersistence.fetchByPrimaryKey(onlinetestResultEntryId);
	}
	 ...
	 */
	@Override
	public OnlinetestResultEntry getOnlinetestResultEntry(
		long onlinetestResultEntryId) throws PortalException, SystemException {
		return onlinetestResultEntryPersistence.findByPrimaryKey(onlinetestResultEntryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return onlinetestResultEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<OnlinetestResultEntry> getOnlinetestResultEntries(int start,
		int end) throws SystemException {
		return onlinetestResultEntryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getOnlinetestResultEntriesCount() throws SystemException {
		return onlinetestResultEntryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public OnlinetestResultEntry updateOnlinetestResultEntry(
		OnlinetestResultEntry onlinetestResultEntry) throws SystemException {
		return onlinetestResultEntryPersistence.update(onlinetestResultEntry);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.vietnamobile.model.OnlinetestResultEntry",
			onlinetestResultEntryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = onlinetestResultEntryPersistence.getDataSource();
	...
	private OnlinetestResultEntryLocalServiceClpInvoker _clpInvoker = new OnlinetestResultEntryLocalServiceClpInvoker();
}
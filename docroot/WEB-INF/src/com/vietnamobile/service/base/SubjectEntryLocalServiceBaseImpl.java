...
import com.vietnamobile.service.SubjectEntryLocalService;
...
/**
 * Provides the base implementation for the subject entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vietnamobile.service.impl.SubjectEntryLocalServiceImpl}.
 * </p>
 *
 * @author duymb
 ...
 * @generated
 */
public abstract class SubjectEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SubjectEntryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vietnamobile.service.SubjectEntryLocalServiceUtil} to access the subject entry local service.
	 */
	...
	@Override
	public SubjectEntry addSubjectEntry(SubjectEntry subjectEntry)
		throws SystemException {
		subjectEntry.setNew(true);

		return subjectEntryPersistence.update(subjectEntry);
	}
	 ...
	 */
	@Override
	public SubjectEntry createSubjectEntry(long subjectEntryId) {
		return subjectEntryPersistence.create(subjectEntryId);
	}
	...
	@Override
	public SubjectEntry deleteSubjectEntry(long subjectEntryId)
		throws PortalException, SystemException {
		return subjectEntryPersistence.remove(subjectEntryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SubjectEntry deleteSubjectEntry(SubjectEntry subjectEntry)
		throws SystemException {
		return subjectEntryPersistence.remove(subjectEntry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SubjectEntry.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return subjectEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return subjectEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SubjectEntry fetchSubjectEntry(long subjectEntryId)
		throws SystemException {
		return subjectEntryPersistence.fetchByPrimaryKey(subjectEntryId);
	}
	 ...
	 */
	@Override
	public SubjectEntry getSubjectEntry(long subjectEntryId)
		throws PortalException, SystemException {
		return subjectEntryPersistence.findByPrimaryKey(subjectEntryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return subjectEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SubjectEntry> getSubjectEntries(int start, int end)
		throws SystemException {
		return subjectEntryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSubjectEntriesCount() throws SystemException {
		return subjectEntryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SubjectEntry updateSubjectEntry(SubjectEntry subjectEntry)
		throws SystemException {
		return subjectEntryPersistence.update(subjectEntry);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.vietnamobile.model.SubjectEntry",
			subjectEntryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = subjectEntryPersistence.getDataSource();
	...
	private SubjectEntryLocalServiceClpInvoker _clpInvoker = new SubjectEntryLocalServiceClpInvoker();
}
...
import com.vietnamobile.service.OnlinetestEntryLocalService;
...
/**
 * Provides the base implementation for the onlinetest entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vietnamobile.service.impl.OnlinetestEntryLocalServiceImpl}.
 * </p>
 *
 * @author duymb
 ...
 * @generated
 */
public abstract class OnlinetestEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements OnlinetestEntryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vietnamobile.service.OnlinetestEntryLocalServiceUtil} to access the onlinetest entry local service.
	 */
	...
	@Override
	public OnlinetestEntry addOnlinetestEntry(OnlinetestEntry onlinetestEntry)
		throws SystemException {
		onlinetestEntry.setNew(true);

		return onlinetestEntryPersistence.update(onlinetestEntry);
	}
	 ...
	 */
	@Override
	public OnlinetestEntry createOnlinetestEntry(long onlinetestEntryId) {
		return onlinetestEntryPersistence.create(onlinetestEntryId);
	}
	...
	@Override
	public OnlinetestEntry deleteOnlinetestEntry(long onlinetestEntryId)
		throws PortalException, SystemException {
		return onlinetestEntryPersistence.remove(onlinetestEntryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public OnlinetestEntry deleteOnlinetestEntry(
		OnlinetestEntry onlinetestEntry) throws SystemException {
		return onlinetestEntryPersistence.remove(onlinetestEntry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(OnlinetestEntry.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return onlinetestEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return onlinetestEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public OnlinetestEntry fetchOnlinetestEntry(long onlinetestEntryId)
		throws SystemException {
		return onlinetestEntryPersistence.fetchByPrimaryKey(onlinetestEntryId);
	}
	 ...
	 */
	@Override
	public OnlinetestEntry getOnlinetestEntry(long onlinetestEntryId)
		throws PortalException, SystemException {
		return onlinetestEntryPersistence.findByPrimaryKey(onlinetestEntryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return onlinetestEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<OnlinetestEntry> getOnlinetestEntries(int start, int end)
		throws SystemException {
		return onlinetestEntryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getOnlinetestEntriesCount() throws SystemException {
		return onlinetestEntryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public OnlinetestEntry updateOnlinetestEntry(
		OnlinetestEntry onlinetestEntry) throws SystemException {
		return onlinetestEntryPersistence.update(onlinetestEntry);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.vietnamobile.model.OnlinetestEntry",
			onlinetestEntryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = onlinetestEntryPersistence.getDataSource();
	...
	private OnlinetestEntryLocalServiceClpInvoker _clpInvoker = new OnlinetestEntryLocalServiceClpInvoker();
}
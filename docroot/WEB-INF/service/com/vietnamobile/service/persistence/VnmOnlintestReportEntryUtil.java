...
/**
 * The persistence utility for the vnm onlintest report entry service. This utility wraps {@link VnmOnlintestReportEntryPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see VnmOnlintestReportEntryPersistenceImpl
 * @generated
 */
public class VnmOnlintestReportEntryUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public static void clearCache(
		...
		getPersistence().clearCache(vnmOnlintestReportEntry);
	}
	 ...
	 */
	public static List<VnmOnlintestReportEntry> findWithDynamicQuery(
	 ...
	 */
	public static VnmOnlintestReportEntry update(
		VnmOnlintestReportEntry vnmOnlintestReportEntry)
		throws SystemException {
		return getPersistence().update(vnmOnlintestReportEntry);
	}
	...
	public static VnmOnlintestReportEntry update(
		...
		return getPersistence().update(vnmOnlintestReportEntry, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(vnmOnlintestReportEntry);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<com.vietnamobile.model.VnmOnlintestReportEntry> vnmOnlintestReportEntries) {
		getPersistence().cacheResult(vnmOnlintestReportEntries);
	}
	...
	*/
	public static com.vietnamobile.model.VnmOnlintestReportEntry create(
		long vnmOnlintestReportEntryId) {
		return getPersistence().create(vnmOnlintestReportEntryId);
	}
	...
	*/
	public static com.vietnamobile.model.VnmOnlintestReportEntry remove(
		long vnmOnlintestReportEntryId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.vietnamobile.NoSuchVnmOnlintestReportEntryException {
		return getPersistence().remove(vnmOnlintestReportEntryId);
	}

	public static com.vietnamobile.model.VnmOnlintestReportEntry updateImpl(
		com.vietnamobile.model.VnmOnlintestReportEntry vnmOnlintestReportEntry)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(vnmOnlintestReportEntry);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.vietnamobile.model.VnmOnlintestReportEntry findByPrimaryKey(
		long vnmOnlintestReportEntryId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.vietnamobile.NoSuchVnmOnlintestReportEntryException {
		return getPersistence().findByPrimaryKey(vnmOnlintestReportEntryId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.vietnamobile.model.VnmOnlintestReportEntry fetchByPrimaryKey(
		long vnmOnlintestReportEntryId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(vnmOnlintestReportEntryId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.vietnamobile.model.VnmOnlintestReportEntry> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static VnmOnlintestReportEntryPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (VnmOnlintestReportEntryPersistence)PortletBeanLocatorUtil.locate(com.vietnamobile.service.ClpSerializer.getServletContextName(),
					VnmOnlintestReportEntryPersistence.class.getName());

			ReferenceRegistry.registerReference(VnmOnlintestReportEntryUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(VnmOnlintestReportEntryPersistence persistence) {
	}

	private static VnmOnlintestReportEntryPersistence _persistence;
}
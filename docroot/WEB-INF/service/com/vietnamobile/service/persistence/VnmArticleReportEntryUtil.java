...
/**
 * The persistence utility for the vnm article report entry service. This utility wraps {@link VnmArticleReportEntryPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class VnmArticleReportEntryUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(VnmArticleReportEntry vnmArticleReportEntry) {
		getPersistence().clearCache(vnmArticleReportEntry);
	}
	 ...
	 */
	public static List<VnmArticleReportEntry> findWithDynamicQuery(
	 ...
	 */
	public static VnmArticleReportEntry update(
		VnmArticleReportEntry vnmArticleReportEntry) throws SystemException {
		return getPersistence().update(vnmArticleReportEntry);
	}
	...
	public static VnmArticleReportEntry update(
		...
		return getPersistence().update(vnmArticleReportEntry, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(vnmArticleReportEntry);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(vnmArticleReportEntries);
	}
	...
	*/
	public static com.vietnamobile.model.VnmArticleReportEntry create(
		long vnmArticleReportEntryId) {
		return getPersistence().create(vnmArticleReportEntryId);
	}
	...
	*/
	public static com.vietnamobile.model.VnmArticleReportEntry remove(
		long vnmArticleReportEntryId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.vietnamobile.NoSuchVnmArticleReportEntryException {
		return getPersistence().remove(vnmArticleReportEntryId);
	}

	public static com.vietnamobile.model.VnmArticleReportEntry updateImpl(
		com.vietnamobile.model.VnmArticleReportEntry vnmArticleReportEntry)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(vnmArticleReportEntry);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.vietnamobile.model.VnmArticleReportEntry findByPrimaryKey(
		long vnmArticleReportEntryId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.vietnamobile.NoSuchVnmArticleReportEntryException {
		return getPersistence().findByPrimaryKey(vnmArticleReportEntryId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.vietnamobile.model.VnmArticleReportEntry fetchByPrimaryKey(
		long vnmArticleReportEntryId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(vnmArticleReportEntryId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.vietnamobile.model.VnmArticleReportEntry> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static VnmArticleReportEntryPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (VnmArticleReportEntryPersistence)PortletBeanLocatorUtil.locate(com.vietnamobile.service.ClpSerializer.getServletContextName(),
					VnmArticleReportEntryPersistence.class.getName());

			ReferenceRegistry.registerReference(VnmArticleReportEntryUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(VnmArticleReportEntryPersistence persistence) {
	}

	private static VnmArticleReportEntryPersistence _persistence;
}
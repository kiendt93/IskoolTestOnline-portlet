...
/**
 * Provides the local service interface for VnmOnlintestReportEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author duymb
 * @see VnmOnlintestReportEntryLocalServiceUtil
...
public interface VnmOnlintestReportEntryLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VnmOnlintestReportEntryLocalServiceUtil} to access the vnm onlintest report entry local service. Add custom service methods to {@link com.vietnamobile.service.impl.VnmOnlintestReportEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

...
/**
 * Provides the local service interface for SubjectEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author duymb
 * @see SubjectEntryLocalServiceUtil
...
public interface SubjectEntryLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SubjectEntryLocalServiceUtil} to access the subject entry local service. Add custom service methods to {@link com.vietnamobile.service.impl.SubjectEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

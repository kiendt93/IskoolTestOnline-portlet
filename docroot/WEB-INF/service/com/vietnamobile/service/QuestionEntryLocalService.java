...
/**
 * Provides the local service interface for QuestionEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author duymb
 * @see QuestionEntryLocalServiceUtil
...
public interface QuestionEntryLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QuestionEntryLocalServiceUtil} to access the question entry local service. Add custom service methods to {@link com.vietnamobile.service.impl.QuestionEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
